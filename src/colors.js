...
const COLORS_DARK = {
  purple: "rgba(206,  92, 255, 0.26)",
  green: "rgba(132, 189,   0, 0.26)",
  teal: "rgba(  0, 189, 163, 0.26)",
  blue: "rgba(117, 163, 255, 0.26)",
  orange: "rgba(240, 140,   0, 0.26)",
};
...
module.exports = { COLORS, COLORS_DARK, CONSTANTS, NUMBERS };
